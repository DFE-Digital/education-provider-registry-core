...
namespace DfE.EducationProviderRegistry.Core.Query.IntegrationTests.Tests.Search.UseCaseTests.Sort;
...
public sealed class SearchUseCaseSortTests : UseCaseIntegrationTestBase
{
    ...
    {
        builder
            .StubFilterOptions(FilterKeyToFilterExpressionMapOptionsStub.StubFilter)
