using DfE.EducationProviderRegistry.Core.Query.Contracts.TestDoubles.Search.Configuration;
...
public sealed class SearchContainsBehaviourTests : SearchUseCaseMatchesResultsTestBase
{
